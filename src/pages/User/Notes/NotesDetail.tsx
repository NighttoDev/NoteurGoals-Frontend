...
const NoteDetailPage: React.FC = () => {
  ...
  const loadData = async (noteId: string) => {
    try {
      ...
      console.log("Available goals IDs:", mappedGoals.map((g) => g.id));

      // Debug: So sánh IDs
      linkedGoalIds.forEach((linkedId) => {
        const found = mappedGoals.find((g) => g.id === linkedId);
        console.log(
          `Linked goal ${linkedId} found in goals list:`,
          found
        );
      });
      ...
      <div className="note-detail-layout">
        ...
        <div className="note-detail-content-column">
          ...
          >
            ...
            <div className="note-detail-content-editor" style={{ color: "#000000" }}>
              <textarea
                value={form.content}
